...
const briefs: IllustrationBrief[] = [
  {
    id: 1,
    chapter: "Chapter 1",
    prompt: "A cartoon-realistic, colorful illustration of Mira, a young girl, following a trail of tiny blue sparks across a red Martian plain towards a gentle robot with a humming silver helmet standing on a ridge. Warm Martian palette (oranges, rusts) with electric blue sparks. High contrast, kid-friendly proportions.",
  ...
  },
  {
    id: 6,
    chapter: "Chapter 6",
    prompt: "A dramatic cartoon-realistic illustration of the experiment: electric blue arcs leaping from a trident to a tall tower, lighting up a skyway path. A crowd of children watches from glass domes. Shimmering light, high contrast.",
...
export const IllustrationGallery: React.FC<{ hasApiKey: boolean; onSelectKey: () => Promise<void> }> = ({ hasApiKey, onSelectKey }) => {
  ...
  return (
    <section id="gallery" className="py-40 bg-space-dark border-t border-white/[0.05]">
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-8">
          <div>
            ...
            <h2 className="font-serif text-5xl md:text-6xl text-white leading-tight">Interior <br/>Illustrations</h2>
          </div>
          <button
            onClick={generateAll}
            disabled={generatingAll}
            className="px-10 py-5 bg-white/5 border border-white/10 text-tesla-silver rounded-full font-bold hover:bg-white hover:text-space-dark transition-all flex items-center gap-3 disabled:opacity-50 shadow-xl"
          >
